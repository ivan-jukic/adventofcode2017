...
type ContentModel
    ...
    | Content15 Day15.Model
    | Content16 Day16.Model
    | Content17 Day17.Model
    | Content19 Day19.Model
    ...
    let
        ...
        ( updated, subCmd ) =
            case ( model.content, msg ) of
                ...
                ( Content15 m, Day15Msg msg ) ->
                    Day15.update msg m |> withSubCmd Content15 Day15Msg

                ( Content16 m, Day16Msg msg ) ->
                    Day16.update msg m |> withSubCmd Content16 Day16Msg

                ( Content17 m, Day17Msg msg ) ->
                    Day17.update msg m |> withSubCmd Content17 Day17Msg

                ( Content19 m, Day19Msg msg ) ->
                    Day19.update msg m |> withSubCmd Content19 Day19Msg
    ...
    div [ class "root-view" ]
        ...
        , div [ class "puzzle-content" ]
            [ case model.content of
                ...
                Content15 m ->
                    Day15.view m |> Html.map Day15Msg

                Content16 m ->
                    Day16.view m |> Html.map Day16Msg

                Content17 m ->
                    Day17.view m |> Html.map Day17Msg

                Content19 m ->
                    Day19.view m |> Html.map Day19Msg
...
initDay15 =
    let
        (model, subCmd) =
            Day15.initialModel
    in
    ChangeContent (Content15 model) (Cmd.map Day15Msg subCmd)
...
initDay16 =
    let
        (model, subCmd) =
            Day16.initialModel
    in
    ChangeContent (Content16 model) (Cmd.map Day16Msg subCmd)
...
initDay17 =
    let
        (model, subCmd) =
            Day17.initialModel
    in
    ChangeContent (Content17 model) (Cmd.map Day17Msg subCmd)
...
initDay19 =
    let
        (model, subCmd) =
            Day19.initialModel
    in
    ChangeContent (Content19 model) (Cmd.map Day19Msg subCmd)
